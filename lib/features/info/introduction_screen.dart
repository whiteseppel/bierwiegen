          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Wertung', style: TextStyles.subheading),
                Text(AppStrings.bierwiegenScoringModes),
                Text('Zielvorgabe', style: TextStyles.subheading),
                Text(AppStrings.bierwiegenTargetModes),
